...
function reducer(state, { type, payload }) {
  switch (type) {
    ...
    // if conditions added to limit to only being able to put a zero if the input of the user has been started
    //       and limit the usage of period to one if it is already within the input of the user
...
function evaluate ({currentOperand, prevOperand, operation}){
  ...
  if (isNaN(prev) || isNaN(current)) return ""  //if theyre not a number return nothing
  let computation = ""
  switch (operation){
    case "+":
